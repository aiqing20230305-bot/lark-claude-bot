...
**触发条件：** 用户说「PlanMode」、「先给方案」、「还没定方向」、「你先给几个思路」
...
|------|------|---------|
| 素材下载/检查 | ████░░░░░░ 40% | ⏳ 准备素材 |
| Credits 确认 + 提交生成 | ██████░░░░ 60% | ⏳ 提交生成中 |
| 等待渲染 | ████████░░ 80% | ⏳ 渲染中约2-5分钟 |
| 视频取回 + 上传群 | ██████████ 100% | ✅ 已完成 |

---

### 第三步：Credits 检查（生成前必做，避免空跑）

提交视频生成前，先检查账户余额：
- 即梦(Dreamina)：调用 run_dreamina args=["user_credit"]
- 若余额为 0：PATCH 工作台卡片为「❌ Credits 不足，充值后继续」，停止运行，不空跑
- 余额充足：继续执行
